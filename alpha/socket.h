#ifndef __ALPHA_SOCKET_H__
#define __ALPHA_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(alphaMin::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(alphaMin::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(alphaMin::Address::ptr address);
