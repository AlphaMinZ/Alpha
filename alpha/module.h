...
//     virtual bool onConnect(alphaMin::Stream::ptr stream);
//     virtual bool onDisconnect(alphaMin::Stream::ptr stream);
    
//     virtual bool onServerReady();
//     virtual bool onServerUp();

//     virtual bool handleRequest(alphaMin::Message::ptr req
//                                ,alphaMin::Message::ptr rsp
//                                ,alphaMin::Stream::ptr stream);
//     virtual bool handleNotify(alphaMin::Message::ptr notify
//                               ,alphaMin::Stream::ptr stream);
...
//     virtual bool handleRockRequest(alphaMin::RockRequest::ptr request
//                         ,alphaMin::RockResponse::ptr response
//                         ,alphaMin::RockStream::ptr stream) = 0;
//     virtual bool handleRockNotify(alphaMin::RockNotify::ptr notify
//                         ,alphaMin::RockStream::ptr stream) = 0;
...
// typedef alphaMin::Singleton<ModuleManager> ModuleMgr;
