#ifndef __ALPHA_TCP_SERVER_H__
#define __ALPHA_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(alphaMin::IOManager* worker = alphaMin::IOManager::GetThis()
                ,alphaMin::IOManager* io_woker = alphaMin::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(alphaMin::Address::ptr addr, bool ssl = false);
